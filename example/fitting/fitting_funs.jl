...
function rat_kernfun_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  out = 1.0/abs2(1.0 + abs2(norm(x1-x2)/parms[2]))
  return out
end

function rat_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nx12 = norm(x1-x2)
...
function rat_kernfun_d1_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nx12 = norm(x1-x2)
  alp  = 4.0*abs2(nx12)
  out  = alp*(parms[2] + abs2(nx12)/parms[2])^(-3)
  return out
...
function rat_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nx12 = norm(x1-x2)
  alp  = 4.0*parms[1]*abs2(nx12)
...
function prt_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nx12 = norm(x1-x2)
  alp  = 4.0*abs2(nx12)
...
function prt_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nx12 = norm(x1-x2)
  alp  = 4.0*abs2(nx12)
...
function besselk_dnu(nu::Number, x::Number)
  ep = give_eps(nu)
  (besselk(nu+ep, x)-besselk(nu-ep, x))/(2.0*ep)
end
...
function mtn_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
...
function mtn_kernfun_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out  = 1.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d1_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  return 0.0 ;
end

function mtn_kernfun_d1_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d1_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d2_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mtn_kernfun_d3_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], parms[3]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pmt_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
...
function pmt_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], parms[2]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pmt_kernfun_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], parms[2]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pmt_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], parms[2]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pmt_kernfun_d2_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], parms[2]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pmt_kernfun_d3_d3(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], parms[2]
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mt1_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
...
function mt1_kernfun_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], 1.0
  out  = 1.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mt1_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], 1.0
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mt1_kernfun_d1_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], 1.0
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function mt1_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = parms[1], parms[2], 1.0
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pm1_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
...
function pm1_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], 1.0
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function pm1_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1, nu = 1.0, parms[1], 1.0
  out = 0.0
  nx12 = norm(x1-x2)
  if nx12 > 0.0
...
function hmt_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
...
function hmt_kernfun_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = 1.0, parms[2]
  out    = t0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function hmt_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = parms[1], parms[2]
  out    = 0.0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function hmt_kernfun_d1_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = 1.0, parms[2]
  out    = 0.0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function hmt_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = parms[1], parms[2]
  out    = 0.0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function pht_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = 1.0, parms[1]
  out    = t0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function pht_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = 1.0, parms[1]
  out    = 0.0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function pht_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  t0, t1 = 1.0, parms[1]
  out    = 0.0
  nx12   = norm(x1-x2)
  if nx12 > 0
...
function sm1_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = parms[1], parms[2]
  nx12  = norm(x1-x2)
...
function sm1_kernfun_d1(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = parms[1], parms[2]
  nx12  = norm(x1-x2)
...
function sm1_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = parms[1], parms[2]
  nx12  = norm(x1-x2)
...
function sm1_kernfun_d1_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = parms[1], parms[2]
  nx12  = norm(x1-x2)
...
function sm1_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = parms[1], parms[2]
  nx12  = norm(x1-x2)
...
function ps1_kernfun(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = 1.0, parms[1]
  nx12  = norm(x1-x2)
  out   = t0*(abs2(t1)/(4.0*nu))*(gamma(nu)*(2.0^(nu-1.0)))
...
function ps1_kernfun_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = 1.0, parms[1]
  nx12  = norm(x1-x2)
  out   = t0*2.0*(t1/(4.0*nu))*(gamma(nu)*(2.0^(nu-1.0)))
...
function ps1_kernfun_d2_d2(x1::AbstractVector, x2::AbstractVector, parms::Vector)
  nu    = 1.0
  t0,t1 = 1.0, parms[1]
  nx12  = norm(x1-x2)
  out   = t0*(2.0/(4.0*nu))*(gamma(nu)*(2.0^(nu-1.0)))
